      ...
      <div className="steps-flow">
        <div className="step-block">
            ...
            <div className="step-content">
                ...
                <p className="step-desc">
                    Read our up-to-date articles<br/>
        ...
        <div className="step-block">
            <div className="step-content">
                <img className="step-desc-bullet" alt="" src={ellipse} />
                <p className="step-desc">
                    Search through our travel<br/>
                    itineraries and pick the most<br/>
                    appealing route.
                </p>
            </div>
            <div className="step-images-container">
        ...
        <div className="step-block">
            ...
            <div className="step-content">
                <img className="step-desc-bullet" alt="" src={ellipse} />
                <p className="step-desc">
                Invite other fellow nomads to join<br/>
                you or simply come in on<br/>
                somebody’s trip.
                </p>
            </div>
        </div>
        <div className="step-block">
            <div className="step-content">
                <img className="step-desc-bullet" alt="" src={ellipse} />
                <p className="step-desc">
                    Discuss travel details<br/>with your new travel buddies.
                </p>
            </div>
            <div className="step-images-container">
                <img src={step4} />
        ...
        <div className="step-block">
            ...
            <div className="step-content">
                <img className="step-desc-bullet" alt="" src={ellipse} />
                <p className="step-desc">
                No worries!<br/>Our city guides will help you out.
                </p>
            </div>
        </div>
        <div className="step-block">
            <div className="step-content">
                <img className="step-desc-bullet" alt="" src={ellipse} />
                <p className="step-desc">
                Have an adventure<br/>of your lifetime together!
                </p>
            </div>
            <div className="step-images-container">
                <img src={step6} alt="" />
